        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="row">
                    ...
                    <form action="{{ url('borrow') }}" enctype="multipart/form-data" method="post" id="my_form">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        <input type="hidden" name="book_id" value="{{ $book_id }}">
                        <div class="form-group col-md-12">
                            <label for="exampleInputName2">借书人 <span style="color: red;"><b>*</b></span></label>
                            <input type="text" class="form-control" id="exampleInputName2" placeholder="" name="username">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail2">借书人工号</label>
                            <input type="text" class="form-control" id="exampleInputEmail2" placeholder="" name="userno">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail2">借书人手机号码</label>
                            <input type="text" class="form-control" id="exampleInputEmail2" placeholder="" name="phone">
                        </div>
                        <div class="form-group input-append date" id="datetimepicker" data-date="{{ date('Y-m-d hh:ii') }}" data-date-format="yyyy-mm-dd hh:ii">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail2" placeholder="" name="return_at" value="{{ date('Y-m-d H:i') }}" readonly>
